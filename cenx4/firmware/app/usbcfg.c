...
static const uint8_t vcom_configuration_descriptor_data[] = {
 ...
 USB_DESC_INTERFACE_ASSOCIATION(0x00, /* bFirstInterface.                  */
  ...
  0x06, 0x24, 0x02, 0x01, 0x01, 0x06,                   //   IN  Jack 1 (emb)       MIDI IN JACK DESC (bLength bDescType bDescSubType bJackType bJackID iJack)
...
static const USBEndpointConfig ep2config = {
  ...
  NULL,
  bduDataTransmitted, //  sduInterruptTransmitted,
  bduDataReceived,
  0x0040,
  0x0040,
  &ep2instate,
